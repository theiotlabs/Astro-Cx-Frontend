...
export default function AboutPage() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-dark-bg text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <main className="grow max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="font-heading font-extrabold text-4xl sm:text-5xl mb-4 text-transparent bg-clip-text bg-linear-to-r from-primary to-secondary">
            About AstroMobile
          </h1>
