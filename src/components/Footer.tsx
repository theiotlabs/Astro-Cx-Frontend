  ...
  return (
    <footer className="bg-slate-100 dark:bg-dark-card border-t border-slate-200 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 mt-12 pt-8 text-center text-xs text-slate-500 dark:text-slate-400">
          <p>© {new Date().getFullYear()} AstroMobile. All rights reserved. Built with advanced numerology algorithms.</p>
        </div>
      </div>
    </footer>
  );
